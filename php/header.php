...
<head>
<meta charset="utf-8">
<title>Olin &middot; <?php echo $page_title; ?></title>
	    ...
	    <ul class="nav navbar-nav">
	    	<li class="dropdown">
	    		...
	    		<ul class="dropdown-menu">
	    			...
	    			<li><a href="contact">Contact - Full Width</a></li>
  					<li><a href="#contact" data-toggle="modal">Contact - Popup (Modal)</a></li>
  					<li><a href="coming-soon">Coming Soon</a></li>
  					<li><a href="coming-soon-bg-image">Coming Soon (Background)</a></li>
	    	...
	    	<li class="dropdown">
	    		...
	    		<ul class="dropdown-menu">
    				...
    				<li><a href="portfolio-masonry">Masonry Layout</a></li>
    				<li><a href="single-project-gallery">Single Project - Gallery</a></li>
    				<li><a href="single-project-slider">Single Project - Slider</a></li>
    				<li><a href="single-project-slider-full-width">Single Project - Slider Full Width</a></li>    				
  				</ul>
	    	</li>
	    	<li class="dropdown">
	    		<a href="#">Blog</a>
	    		<ul class="dropdown-menu">
  					...
  					<li><a href="blog-post-slider">Blog Post - Slider</a></li>
  					<li><a href="blog-post-gallery">Blog Post - Gallery</a></li>
  					<li><a href="blog-post-video">Blog Post - Video</a></li>
  				</ul>
	    	</li>
